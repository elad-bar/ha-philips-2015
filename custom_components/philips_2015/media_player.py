...
from homeassistant.components.media_player.const import (SUPPORT_STOP, SUPPORT_TURN_ON,
...
SUPPORT_PHILIPS_2016 = SUPPORT_STOP | SUPPORT_TURN_ON | SUPPORT_TURN_OFF | SUPPORT_VOLUME_STEP | \
                       SUPPORT_VOLUME_MUTE | SUPPORT_VOLUME_SET
                       # |SUPPORT_NEXT_TRACK | \
...
class PhilipsTVBase(object):
    ...
    def getChannels(self):
        ...
        if r:
            ...
            self.channel_source_list.append("HDMI1")
            self.channel_source_list.append("HDMI2")
